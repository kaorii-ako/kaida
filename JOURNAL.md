...
Started laying out the keyboard in KLE (Keyboard Layout Editor) JSON format — `keyboard-layout.json`. Went with a TKL-ish arrangement but kept a dedicated arrow cluster and a lone `Del` key up top instead of going full 96%.
